...
cp "$ROOT_DIR/index-jp.html" "$SITE_DIR/index-jp.html"
cp "$ROOT_DIR/login.html" "$SITE_DIR/login.html"
cp "$ROOT_DIR/login-jp.html" "$SITE_DIR/login-jp.html"
cp "$ROOT_DIR/signup.html" "$SITE_DIR/signup.html"
cp "$ROOT_DIR/signup-jp.html" "$SITE_DIR/signup-jp.html"
cp "$ROOT_DIR/profile.html" "$SITE_DIR/profile.html"
cp "$ROOT_DIR/profile-jp.html" "$SITE_DIR/profile-jp.html"
cp "$ROOT_DIR/runtime-config.js" "$SITE_DIR/runtime-config.js"
cp "$ROOT_DIR/global.css" "$SITE_DIR/global.css"
